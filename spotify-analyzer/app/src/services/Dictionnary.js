...
import Album from '@clabroche/spotify-analyzer-models/src/models/Album'
import Artist from '@clabroche/spotify-analyzer-models/src/models/Artist'
import Track from '@clabroche/spotify-analyzer-models/src/models/Track'
import debounce from 'debounce'

/** @type {import('vue').Ref<Object<string, import('@clabroche/spotify-analyzer-models/src/models/Artist')>>} */
const artists = ref({})
/** @type {import('vue').Ref<string[]>} */
const artistsId = ref([])

/** @type {import('vue').Ref<Object<string, import('@clabroche/spotify-analyzer-models/src/models/Album')>>} */
const albums = ref({})
/** @type {import('vue').Ref<string[]>} */
const albumsId = ref([])

/** @type {import('vue').Ref<Object<string, import('@clabroche/spotify-analyzer-models/src/models/Track')>>} */
const tracks = ref({})
/** @type {import('vue').Ref<string[]>} */
const tracksId = ref([])
